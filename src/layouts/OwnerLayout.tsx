                ...
                <div className="absolute right-0 mt-2 w-80 bg-card border rounded-2xl shadow-2xl p-4 z-50 animate-in fade-in zoom-in-95 duration-150 text-foreground">
                  <div className="flex items-center justify-between border-b pb-2">
                    <h4 className="font-extrabold text-xs uppercase tracking-wider text-foreground">
                      Owner Alerts ({notifications.length})
                    </h4>
                        ...
                        <div
                          ...
                          onClick={() => {
                            ...
                            if (!target) {
                              ...
                              if (titleLower.includes('financial') || titleLower.includes('distribution') || msgLower.includes('paid')) {
                                target = '/owner/financials';
                              } else if (titleLower.includes('maintenance') || msgLower.includes('repair')) {
                                target = '/owner/maintenance';
                              } else {
